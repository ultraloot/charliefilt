...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>
 🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/Ultraloot23'>Safvan</a>
 📚 ʟɪʙʀᴀʀʏ : No library....
 📝 ʟᴀɴɢᴜᴀɢᴇ : Malayalam
 ♻️ ᴅᴀᴛᴀ ʙᴀsᴇ : Paid 🤫
 📡 ʜᴏsᴛᴇᴅ ᴏɴ  : Heroku🥱
 🥶 ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴀᴄᴛɪᴠᴇ ✅</b>"""
    ...
    SOURCE_TXT = """
<b>Buy From @Ultraloot23 500rs</b>"""
...
<a href="tg://openmessage?user_id={}">{user}</a>"""
    ...
    ALRT_TXT = """Not Requested By You...😒"""

    OLD_ALRT_TXT = """This message is old. please request movie again.....🥱"""

    CUDNT_FND = """സിനിമയുടെ പേര് തെറ്റാണെന്ന് തോന്നുന്നു."""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>കാണാൻ താല്പര്യമുള്ള മറ്റു സിനിമകൾ ഗ്രൂപ്പിൽ ചോദിക്കാം  👇👇👇

💢GROUP      🔽
1) https://t.me/+nv7kar6_FL8wNGZl</b>"""

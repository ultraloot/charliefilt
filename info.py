...
API_ID = int(environ.get('API_ID', '28547341'))
API_HASH = environ.get('API_HASH', 'ce7fff98400710f9b662b334ac4f4b36')
BOT_TOKEN = environ.get('BOT_TOKEN', "6953142067:AAFoICP_nQvw1ed1bgoM4CWXJ-BF0I9vY00")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6082136901').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002118755526').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1002080628176")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a61938d858dae504f3b394d4f699fa233e9c99a7')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'omnifly.in.net')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'a61938d858dae504f3b394d4f699fa233e9c99a7')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ultrasmoviegroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/umoviesearch')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/MOVIESHD_tutorial/53')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'âš¡')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001629880221'))
